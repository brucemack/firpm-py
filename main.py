...
h, dev = firpm.firpm(24, 1, 2, [ 0.00, 0.08, 0.16, 0.5 ], [ 1.0, 0.0 ], [ 1.0, 1.0 ])
h.dump()
print("Dev dB", 20 * math.log10(dev))

print("Figure 9 - N=32 bandpass filter")
h, dev = firpm.firpm(32, 1, 3, [ 0.00, 0.10, 0.20, 0.35, 0.425, 0.5 ], 
...
h, dev = firpm.firpm(50, 1, 3, [ 0.00, 0.15, 0.20, 0.30, 0.35, 0.5 ], 
...
h, dev = firpm.firpm(20, 3, 1, [ 0.05, 0.5 ], [ 1.0 ], [ 1.0 ])
h.dump()
print("Dev dB", 20 * math.log10(dev))
